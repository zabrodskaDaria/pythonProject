...
class Player(QtWidgets.QMainWindow, interface.Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_3.clikced.connect(self.load)
    ...
    def play(self):
        ...
        if item:
            ...
            content = QtMultimedia(QtCore.QUrl.formlocalFile(file_name))

            self.mediaPlayer = QtMultimedia(QtCore.QUrl.formLocalFile(file_name))

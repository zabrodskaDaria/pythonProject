...
class Currency():
    ...
    def get_currency_price(self):
        ...
        convert = soup.findAll(span={"class:spec-adv b-spec-adv b-direct,style: position:relative, z-index:-999,top:-30px,display:block,width:30px;height:30px,margin-bottom:-30px"})
